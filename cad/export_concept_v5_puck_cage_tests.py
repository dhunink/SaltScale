"""Export loose captive puck-cage test parts for concept v5."""
...
SRC = BASE / "src"
EXPORT_ROOT = BASE / "exports" / "concept_v5_puck_cage_tests"
STEP_DIR = EXPORT_ROOT / "step"
STL_DIR = EXPORT_ROOT / "stl"

sys.path.append(str(SRC))

from concept_v5_puck_cage_tests import printable_puck_cage_tests  # noqa: E402
...
def main() -> None:
    _ensure_dirs()
    for name, part in printable_puck_cage_tests().items():
    ...
    print(f"Exported concept_v5 puck cage tests to {EXPORT_ROOT}")
